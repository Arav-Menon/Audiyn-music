  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="absolute inset-0 bg-white blur-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 rounded-full animate-pulse-slow"></div>
          <div className="relative bg-white/5 backdrop-blur-sm p-10 rounded-2xl border border-white/10 group-hover:border-white/20 transition-all duration-300 group-hover:scale-105 group-hover:rotate-3">
            {/* <Volume2 className="w-16 h-16 text-white animate-icon-pulse" strokeWidth={1.5} /> */}
